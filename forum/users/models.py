...
class CustomUser(AbstractUser):
    image = models.ImageField(upload_to="users_avatars/", blank=True, verbose_name="Изображение")
...
class UtcOffset(models.Model):
    ...
    description = models.CharField(default="MSK+0", max_length=20, verbose_name="Описание")
